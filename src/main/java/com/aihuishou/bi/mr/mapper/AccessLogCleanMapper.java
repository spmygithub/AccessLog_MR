package com.aihuishou.bi.mr.mapper;

import com.aihuishou.bi.mr.writable.AccessLogWritable;
import com.aihuishou.bi.utils.JedisUtil;
import com.aihuishou.bi.utils.UserAgent;
import com.aihuishou.bi.utils.UserAgentUtil;
...
public class AccessLogCleanMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    //数据来源 web:1000,android:1001,ios:1002,ipad:1003
    private String ip;
    ...
    //请求的状态主要有：200 ok、/404 not found、408 Request Timeout、500 Internal Server Error、504 Gateway Timeout等
    private String httpReferer;
    //请求该url的上一个url地址。
    private String userAgent;
    //览器的信息，例如："Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36"
    ...
    // action对应的时间戳
    private String time;
    //action对应的格式化时间yyyy-MM-dd HH:mm:ss
